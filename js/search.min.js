...
function createEntry(url,title,img,date,category,body,startPos,endPos) {
  return ' <a href=' + url + ' title="' + title + '｜2001Y.me"><article class="post ' + category + '"><picture class=post-tmb><img src=/img/'+ img +'-120.jpg srcset="/img/'+ img +'-240.jpg 2x,/img/'+ img +'-360.jpg 3x" alt="' + title + '｜2001Y.me"></picture><div class=post-data><h2>' + title + '</h2><div class=post-meta><time>' + date + '</time>・' + category + '</div><p>' + excerpt(body, startPos, endPos) + '</p></div></article></a>';
}
